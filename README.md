...
- 시작 인구 10명 → 식량·주택 여유가 있을 때 아이가 태어나 인구가 증가
- 노화·노령 사망, 성년(15세) 전까지는 노동 불가(아동)
- 인구가 늘면 농장·주택·채집장이 인구를 앞서 지어지며 마을이 확장
- 시드별로 다른 성장 궤적(토지 비옥도·확률 요동)
- 인구·아이·평균나이·출생/사망을 관찰판에 노출
- 다음 단계: **시대/단계 잠금해제**로 새 직업·건물·기술을 열어 마을을 더 키움
